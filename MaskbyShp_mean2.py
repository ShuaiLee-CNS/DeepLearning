...
ras_file = r"H:\FCave\FC\geotiff"   #待裁剪的原始栅格数据存储文件夹路径
suffix = 'tif'  #待裁剪的原始栅格数据后缀
bvalue= -9999   #待裁剪的原始栅格数据背景值

shp_file = r"E:\中国边界\黄土高原54个流域控制站以上边界"   #裁剪所需shp模板数据存储文件夹路径

ras_file_cut = r"H:\FCave\FC\smbasin\basin"   #裁剪后栅格数据结果存储文件夹路径
txtname=r"H:\FCave\FC\smbasin\stats"     #输出统计文本路径
